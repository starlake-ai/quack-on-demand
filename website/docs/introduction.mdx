...
- **Give AI agents governed data access**: an embedded [MCP server](/connecting/mcp) lets agents such as Claude Code discover schemas and run SQL with the same per-statement access control as any other client.
...
- **[Quickstart](/getting-started/quickstart)** - from zero to your first query.
- **[Architecture](/concepts/architecture)** - how the pieces fit and how a request flows.
- **[Connecting clients](/connecting/clients)** - JDBC, ADBC, ODBC, and more.
- **[Operating](/operating/deploy-local)** - deploy, provision tenants and pools, govern access.
